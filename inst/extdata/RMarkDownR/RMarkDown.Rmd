...
state_plots =  list.files('Inputs/10X-gex', pattern = 'UMAP_Plot.png', recursive = T)

state_plots = paste0('Inputs/10X-gex/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("UMAP_Plot.png" = "", "Inputs/10X-gex/" = "")))
...
state_plots =  list.files('Inputs/10X-gex-grouped', pattern = 'UMAP_Plot.png', recursive = T)

state_plots = paste0('Inputs/10X-gex-grouped/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("UMAP_Plot.png" = "", "Inputs/10X-gex-grouped/" = "")))
...
state_plots =  list.files('Inputs/10X-gex', pattern = 'tSNE_Plot.png', recursive = T)

state_plots = paste0('Inputs/10X-gex/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("tSNE_Plot.png" = "", "Inputs/10X-gex/" = "")))
...
state_plots =  list.files('Inputs/10X-gex-grouped', pattern = 'tSNE_Plot.png', recursive = T)

state_plots = paste0('Inputs/10X-gex-grouped/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("tSNE_Plot.png" = "", "Inputs/10X-gex-grouped/" = "")))
...
state_plots =  list.files('Inputs/10X-gex', pattern = 'HeatMap.png', recursive = T)

state_plots = paste0('Inputs/10X-gex/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("Celltype_assignment_HeatMap.png" = "", "Inputs/10X-gex/" = "")))
...
state_plots =  list.files('Inputs/10X-gex-grouped', pattern = 'Celltype_assignment_HeatMap.png', recursive = T)

state_plots = paste0('Inputs/10X-gex-grouped/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("Celltype_assignment_HeatMap.png" = "", "Inputs/10X-gex-grouped/" = "")))
...
state_plots =  list.files('Inputs/10X-gex', pattern = 'TotalUMIvsDetectedGenes.png', recursive = T)

state_plots = paste0('Inputs/10X-gex/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("TotalUMIvsDetectedGenes.png" = "", "Inputs/10X-gex/" = "")))
...
state_plots =  list.files('Inputs/10X-gex-grouped', pattern = 'TotalUMIvsDetectedGenes.png', recursive = T)

state_plots = paste0('Inputs/10X-gex-grouped/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("TotalUMIvsDetectedGenes.png" = "", "Inputs/10X-gex-grouped/" = "")))
...
state_plots =  list.files('Inputs/10X-gex', pattern = 'BarcodeRankPlot_10X.png', recursive = T)

state_plots = paste0('Inputs/10X-gex/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("BarcodeRankPlot_10X.png" = "", "Inputs/10X-gex/" = "")))
...
state_plots =  list.files('Inputs/10X-gex', pattern = 'BarcodeRankPlot_EB.png', recursive = T)

state_plots = paste0('Inputs/10X-gex/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("BarcodeRankPlot_EB.png" = "", "Inputs/10X-gex/" = "")))
...
state_plots =  list.files('Inputs/10X-gex-grouped', pattern = 'BarcodeRankPlot_10X.png', recursive = T)

state_plots = paste0('Inputs/10X-gex-grouped/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("BarcodeRankPlot_10X.png" = "", "Inputs/10X-gex-grouped/" = "")))
...
state_plots =  list.files('Inputs/10X-gex-grouped', pattern = 'BarcodeRankPlot_EB.png', recursive = T)

state_plots = paste0('Inputs/10X-gex-grouped/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("BarcodeRankPlot_EB.png" = "", "Inputs/10X-gex-grouped/" = "")))
