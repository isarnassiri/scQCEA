...
Before running the `GenerateInteractiveQCReport()` function, you need to transfer `metrics_summary.csv` and samples.metadata files to the Inputs/ folder. You can use `MetricsSummary.sh` to automatise transferring files for a scRNA-Seq project (e.g., P230078) as follows:
