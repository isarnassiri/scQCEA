...
GEX_SEQUENCING_ID=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $3}' $SAMPLES_FILE)
GEX_DATA_DIR=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $4}' $SAMPLES_FILE)
HTO_LIBRARY_ID=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $5}' $SAMPLES_FILE)
HTO_SEQUENCING_ID=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $6}' $SAMPLES_FILE)
HTO_DATA_DIR=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $7}' $SAMPLES_FILE)
ADT_LIBRARY_ID=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $8}' $SAMPLES_FILE)
ADT_SEQUENCING_ID=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $9}' $SAMPLES_FILE)
ADT_DATA_DIR=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $10}' $SAMPLES_FILE)
OUTPUT_DIR=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $11}' $SAMPLES_FILE)
DEMUX_METHOD=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $12}' $SAMPLES_FILE)
DEMUX_MS_AT=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $13}' $SAMPLES_FILE)
SAVE_RAW=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $14}' $SAMPLES_FILE)
SAVE_FILTERED=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $15}' $SAMPLES_FILE)
SAVE_SPLITTED=$(awk -F '\t' -v "line=$SLURM_ARRAY_TASK_ID" 'NR==line {print $16}' $SAMPLES_FILE)
